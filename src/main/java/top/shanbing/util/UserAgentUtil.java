...
public class UserAgentUtil {
    ...
    private static Map<String,String> windowsMap = new HashMap<>();
    private static Map<String,String> appleMap = new HashMap<>();

    static {
        windowsMap.put("Windows NT","Windows");
        appleMap.put("iPhone","iPhone");

        maps.put("Windows",windowsMap);
        maps.put("Mac OS X",appleMap);
    }
